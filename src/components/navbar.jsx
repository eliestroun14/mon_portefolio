...
const links = [
    ...
    { url: "/portfolio", title: "Portefolio"},
        ...
        <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
            ...
            <div className="md:hidden lg:flex xl:w-1/3 justify-center">
                <Link href="/"className="text-sm bg-black rounded-md p-1 font-semibold flex items-center justify-center">
                        <span className="text-white mr-1 ">Elie</span>
                        <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">.dev</span>
                </Link>
            </div>
            {/* SOCIALS */}
            <div className="hidden md:flex gap-4 ld:flex w-1/3">
                <Link href={"https://github.com/eliestroun14"}>
                    <Image src="/github.png" alt="" width={24} height={24} />
                </Link>
                <Link href={"https://www.linkedin.com/in/elie-stroun-6b91372a1/"}>
